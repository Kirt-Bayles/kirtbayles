    ...
    return (
        <div>
            <Container className="py-5 text-center text-secondary lh-1">
                ...
                <p>
                    <a href="https://mail.google.com/mail/u/2/#inbox?compose=DmwnWrRtswQDkSxMBQptHTTLVwbVNDcNJmcZKxKJCHClMMzzPBSwgHmkWNLqqvvhxPFKvVvLnzqq"><Image src={gmail} className="bg-secondary p-2 rounded-5 me-4 mt-2"/></a>
